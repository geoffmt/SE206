...
public class DagPackageImpl extends EPackageImpl implements DagPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getChannel_SourcePort(), this.getPort(), null, "sourcePort", null, 0, 1, Channel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getChannel_DestPort(), this.getPort(), null, "destPort", null, 0, 1, Channel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getChannel_DestTask(), this.getTask(), null, "destTask", null, 0, 1, Channel.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, IS_DERIVED, !IS_ORDERED);
		initEReference(getChannel_SourceTask(), this.getTask(), null, "sourceTask", null, 0, 1, Channel.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, IS_DERIVED, !IS_ORDERED);
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (channelEClass,
		   source,
		   new String[] {
			   "constraints", "dataType portsDirections periods"
		   });
	}
