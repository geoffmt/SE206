...
public class DagSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case DagPackage.DAG_SPECIFICATION: {
				DagSpecification dagSpecification = (DagSpecification)theEObject;
				T result = caseDagSpecification(dagSpecification);
				if (result == null) result = caseIdentifiedElement(dagSpecification);
				if (result == null) result = caseNamedElement(dagSpecification);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case DagPackage.CHANNEL: {
				...
				if (result == null) result = caseIdentifiedElement(channel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseDagSpecification(DagSpecification object) {
		return null;
	}
