 ...
 * </p>
 * <ul>
 *   <li>{@link fr.tpt.mem4csd.dag.model.dag.impl.TaskImpl#getName <em>Name</em>}</li>
 *   <li>{@link fr.tpt.mem4csd.dag.model.dag.impl.TaskImpl#getPeriod <em>Period</em>}</li>
 *   <li>{@link fr.tpt.mem4csd.dag.model.dag.impl.TaskImpl#getOwnedPorts <em>Owned Ports</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TaskImpl extends IdentifiedElementImpl implements Task {
	...
	protected EClass eStaticClass() {
		return DagPackage.Literals.TASK;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DagPackage.TASK__NAME, oldName, name));
	}
	...
	public void setPeriod(int newPeriod) {
		...
		period = newPeriod;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DagPackage.TASK__PERIOD, oldPeriod, period));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DagPackage.TASK__OWNED_PORTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DagPackage.TASK__NAME:
				return getName();
			case DagPackage.TASK__PERIOD:
				return getPeriod();
			case DagPackage.TASK__OWNED_PORTS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (derivedFeatureID) {
				case DagPackage.TASK__NAME: return DagPackage.NAMED_ELEMENT__NAME;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (baseFeatureID) {
				case DagPackage.NAMED_ELEMENT__NAME: return DagPackage.TASK__NAME;
				default: return -1;
			}
		}
